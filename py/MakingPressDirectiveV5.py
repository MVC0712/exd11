...
#
#######################################################
wb = openpyxl.load_workbook('direction_sheetV5.xlsx')
...
sheet['d39'] = params["press_machine"]

sheet['d59'] = anull(params["h"])
sheet['d60'] = anull(params["a"])
sheet['d61'] = anull(params["b"])
sheet['d62'] = anull(params["c"])
sheet['d63'] = anull(params["d"])
sheet['d64'] = anull(params["e"])
sheet['d65'] = anull(params["f"])
sheet['d66'] = anull(params["i"])
sheet['d67'] = anull(params["k"])
sheet['d68'] = anull(params["end"])
# print(anull(params["h"]))
