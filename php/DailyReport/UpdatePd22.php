...
update t_press 
  set 
    ...
    no3_1000_ram_speed = :no3_1000_ram_speed,
    no3_1000_ram_pressure = :no3_1000_ram_pressure,
    no3_1000_work_temperature = :no3_1000_work_temperature,
    no3_0200_ram_speed = :no3_0200_ram_speed,
    no3_0200_ram_pressure = :no3_0200_ram_pressure,
    no3_0200_work_temperature = :no3_0200_work_temperature,
    no4_1000_ram_speed = :no4_1000_ram_speed,
    no4_1000_ram_pressure = :no4_1000_ram_pressure,
    no4_1000_work_temperature = :no4_1000_work_temperature,
    no4_0200_ram_speed = :no4_0200_ram_speed,
    no4_0200_ram_pressure = :no4_0200_ram_pressure,
    no4_0200_work_temperature = :no4_0200_work_temperature,
    no5_1000_ram_speed = :no5_1000_ram_speed,
    no5_1000_ram_pressure = :no5_1000_ram_pressure,
    no5_1000_work_temperature = :no5_1000_work_temperature,
    no5_0200_ram_speed = :no5_0200_ram_speed,
    no5_0200_ram_pressure = :no5_0200_ram_pressure,
    no5_0200_work_temperature = :no5_0200_work_temperature,
    ...
    //   $prepare->bindValue(':scrap_weight', $_POST["scrap_weight__input"], PDO::PARAM_STR);
     ...
     $prefixes = ['no2', 'no3', 'no4', 'no5'];
$times = ['0200', '1000'];
$fields = ['ram_speed', 'ram_pressure', 'work_temperature'];

foreach ($prefixes as $prefix) {
    foreach ($times as $time) {
        foreach ($fields as $field) {
            $key = "{$prefix}_{$time}_{$field}";
            $param = ":{$key}";

            if (!isset($_POST[$key]) || $_POST[$key] === '') {
                $prepare->bindValue($param, null, PDO::PARAM_STR);
            } else {
                $prepare->bindValue($param, $_POST[$key], PDO::PARAM_STR);
            }
        }
    }
}
