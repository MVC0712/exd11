...
//  $data_json = array_values($data_json); //配列の並び替え
  ...
  try {
      ...
      $prepare = $dbh->prepare(
        ...
        -- no2_work_length,
        no3_0200_ram_speed,
        no3_0200_ram_pressure,
        no3_0200_work_temperature,
        no3_1000_ram_speed,
        no3_1000_ram_pressure,
        no3_1000_work_temperature,
        -- no3_work_length,
        no4_0200_ram_speed,
        no4_0200_ram_pressure,
        no4_0200_work_temperature,
        no4_1000_ram_speed,
        no4_1000_ram_pressure,
        no4_1000_work_temperature,
        -- no4_work_length,
        no5_0200_ram_speed,
        no5_0200_ram_pressure,
        no5_0200_work_temperature,
        no5_1000_ram_speed,
        no5_1000_ram_pressure,
        no5_1000_work_temperature,
        -- no5_work_length,
        created_at,
