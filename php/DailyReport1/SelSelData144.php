<?php
  ...
  try {
    ...
    DATE_FORMAT(t_press.die_heating_start, '%H:%i') AS die_heating_start,
    DATE_FORMAT(t_press.die_heating_finished, '%H:%i') AS die_heating_finished,
    ...
    DATE_FORMAT(t_press_directive.plan_date_at,
            '%y-%m-%d') AS press_directive_plan_date_at,
