<?php
  ...
  try{
    ...
    REPLACE(IFNULL(FORMAT((SUM(t10.work_quantity) - SUM(t10.total_ng)),
                ...
                0),
        ',',
        '') - REPLACE(FORMAT(t20.packed_work_quantitiy, 0),
        ',',
        '') AS remain
FROM
    m_ordersheet
    ...
    GROUP BY m_ordersheet.production_numbers_id) t20 ON t20.m_ordersheet_id = m_ordersheet.id
GROUP BY m_ordersheet.production_numbers_id
