              ...
              <table style="overflow: auto; width : auto;">
                  <tbody style="overflow: auto; height: 30px;">
                      ...
                      <tr style="border-bottom: 1px solid rgb(0, 0, 0);">
                          ...
                          <td style="width: 55px; font-size: 10px;">&nbsp;</td>
                          <td></td>
                      </tr>
                  </tbody>
              </table>
              <table style="overflow: auto; width : auto;">
                  <tbody style="overflow: auto; height: 40px;">
                      <tr>
                          ...
                          <td style="background-color: #ffff00; width: 80px;"><strong style="font-size: 10px;"></strong></td>
                          <td style="width: 35px;">Vòng khuôn</td>
                          <td style="width: 70px;"><strong style="font-size: 10px; "></strong></td>
                          <td> XN khuôn</td>
                      </tr>
                      <tr style="border-bottom: 1px solid rgb(0, 0, 0);">
              ...
              <table style="overflow: auto; width : auto;">
                  ...
                  <tr>
                      ...
                      <tr>
                          ...
                          <td style="width: 30px; background-color: #ffff00; font-weight: bold;"></td>
                      </tr>
                      <tr>
                          <td style="width: 55px;">Chiều dài đùn</td>
                          <td style="width: 35px; background-color: #ffff00; font-weight: bold;"></td>
