  ...
  ajaxReturnData.forEach(function (trVal) {
    ...
    Object.keys(trVal).forEach(function (tdVal) {
      if (tdVal == "Position" || tdVal == "id") {
        ...
        $("<td>").append(makeJugCodeOptionDom(trVal[tdVal])).appendTo(newTr);
      } else {
        $("<td>").html(trVal[tdVal]).appendTo(newTr);
      }
    });
...
function makeJugCodeOptionDom(seletedId) {
  ...
  jugcode.forEach(function (element) {
    if (element["id"] == seletedId) {
      ...
      $("<option>").html(element["jug"]).val(element["id"]).appendTo(targetDom);
    }
  });
  return targetDom;
}
...
function total_code(code, idcol) {
  var ttcode = $("#data__table tbody td")
    .map(function () {
      return $(this)
        .find("select")
...
$(document).on("click", "#summary_table tbody tr", function (e) {
  if (!$(this).hasClass("selected-record")) {
    ...
    myAjax.myAjax(fileName, sendData);
    $("#table_headder").html(
      $("#selected__tr").find("td").eq(3).html() +
        " (" +
        $("#selected__tr").find("td").eq(1).html() +
        ")",
    );
    ...
    $("#etching__date")
      .val(ajaxReturnData[0]["etching_check_date"])
    ...
    console.log("result =", a * 2 * m * h);
    console.log("ceil =", Math.ceil(a * 2 * m * h));
    for (i = 0; i < Math.ceil(a * 2 * m * h); ++i) {
      let trDom = $("<tr>");
      if (n == 1) {
        if (i % 2 == 0) {
          trDom.append($("<td>").html(Math.ceil((i - n) / (2 * n) + 1) + "H"));
        } else {
          trDom.append($("<td>").html(Math.ceil((i - n) / (2 * n) + 1) + "E"));
        }
      } else if (n == 2) {
        if (i % 4 == 0) {
          trDom.append(
            $("<td>").html(Math.ceil((i - n - 1) / (2 * n) + 1) + "H"),
          );
        } else if (i % 4 == 1) {
          trDom.append(
            $("<td>").html(Math.ceil((i - n - 1) / (2 * n) + 1) + "A"),
          );
        } else if (i % 4 == 2) {
          trDom.append(
            $("<td>").html(Math.ceil((i - n - 1) / (2 * n) + 1) + "B"),
          );
        } else {
          trDom.append(
            $("<td>").html(Math.ceil((i - n - 1) / (2 * n) + 1) + "E"),
          );
        }
      } else if (n == 3) {
        if (i % 6 == 0) {
          trDom.append(
            $("<td>").html(Math.ceil((i - n - 2) / (2 * n) + 1) + "H"),
          );
        } else if (i % 6 == 1) {
          trDom.append(
            $("<td>").html(Math.ceil((i - n - 2) / (2 * n) + 1) + "A"),
          );
        } else if (i % 6 == 2) {
          trDom.append(
            $("<td>").html(Math.ceil((i - n - 2) / (2 * n) + 1) + "B"),
          );
        } else if (i % 6 == 3) {
          trDom.append(
            $("<td>").html(Math.ceil((i - n - 2) / (2 * n) + 1) + "C"),
          );
        } else if (i % 6 == 4) {
          trDom.append(
            $("<td>").html(Math.ceil((i - n - 2) / (2 * n) + 1) + "D"),
          );
        } else {
          trDom.append(
            $("<td>").html(Math.ceil((i - n - 2) / (2 * n) + 1) + "E"),
          );
        }
      } else if (n == 4) {
        if (i % 8 == 0) {
          trDom.append(
            $("<td>").html(Math.ceil((i - n - 3) / (2 * n) + 1) + "H"),
          );
        } else if (i % 8 == 1) {
          trDom.append(
            $("<td>").html(Math.ceil((i - n - 3) / (2 * n) + 1) + "A"),
          );
        } else if (i % 8 == 2) {
          trDom.append(
            $("<td>").html(Math.ceil((i - n - 3) / (2 * n) + 1) + "B"),
          );
        } else if (i % 8 == 3) {
          trDom.append(
            $("<td>").html(Math.ceil((i - n - 3) / (2 * n) + 1) + "C"),
          );
        } else if (i % 8 == 4) {
          trDom.append(
            $("<td>").html(Math.ceil((i - n - 3) / (2 * n) + 1) + "D"),
          );
        } else if (i % 8 == 5) {
          trDom.append(
            $("<td>").html(Math.ceil((i - n - 3) / (2 * n) + 1) + "E"),
          );
        } else if (i % 8 == 6) {
          trDom.append(
            $("<td>").html(Math.ceil((i - n - 3) / (2 * n) + 1) + "F"),
          );
        } else {
          trDom.append(
            $("<td>").html(Math.ceil((i - n - 3) / (2 * n) + 1) + "END"),
          );
        }
      } else if (n == 5) {
        if (i % 10 == 0) {
          trDom.append(
            $("<td>").html(Math.ceil((i - n - 4) / (2 * n) + 1) + "H"),
          );
        } else if (i % 10 == 1) {
          trDom.append(
            $("<td>").html(Math.ceil((i - n - 4) / (2 * n) + 1) + "A"),
          );
        } else if (i % 10 == 2) {
          trDom.append(
            $("<td>").html(Math.ceil((i - n - 4) / (2 * n) + 1) + "B"),
          );
        } else if (i % 10 == 3) {
          trDom.append(
            $("<td>").html(Math.ceil((i - n - 4) / (2 * n) + 1) + "C"),
          );
        } else if (i % 10 == 4) {
          trDom.append(
            $("<td>").html(Math.ceil((i - n - 4) / (2 * n) + 1) + "D"),
          );
        } else if (i % 10 == 5) {
          trDom.append(
            $("<td>").html(Math.ceil((i - n - 4) / (2 * n) + 1) + "E"),
          );
        } else if (i % 10 == 6) {
          trDom.append(
            $("<td>").html(Math.ceil((i - n - 4) / (2 * n) + 1) + "F"),
          );
        } else if (i % 10 == 7) {
          trDom.append(
            $("<td>").html(Math.ceil((i - n - 4) / (2 * n) + 1) + "I"),
          );
        } else if (i % 10 == 8) {
          trDom.append(
            $("<td>").html(Math.ceil((i - n - 4) / (2 * n) + 1) + "K"),
          );
        } else {
          trDom.append(
            $("<td>").html(Math.ceil((i - n - 4) / (2 * n) + 1) + "END"),
          );
        }
      } else if (n == 6) {
        if (i % 12 == 0) {
          trDom.append(
            $("<td>").html(Math.ceil((i - n - 5) / (2 * n) + 1) + "H"),
          );
        } else if (i % 12 == 1) {
          trDom.append(
            $("<td>").html(Math.ceil((i - n - 5) / (2 * n) + 1) + "A"),
          );
        } else if (i % 12 == 2) {
          trDom.append(
            $("<td>").html(Math.ceil((i - n - 5) / (2 * n) + 1) + "B"),
          );
        } else if (i % 12 == 3) {
          trDom.append(
            $("<td>").html(Math.ceil((i - n - 5) / (2 * n) + 1) + "C"),
          );
        } else if (i % 12 == 4) {
          trDom.append(
            $("<td>").html(Math.ceil((i - n - 5) / (2 * n) + 1) + "D"),
          );
        } else if (i % 12 == 5) {
          trDom.append(
            $("<td>").html(Math.ceil((i - n - 5) / (2 * n) + 1) + "E"),
          );
        } else if (i % 12 == 6) {
          trDom.append(
            $("<td>").html(Math.ceil((i - n - 5) / (2 * n) + 1) + "F"),
          );
        } else if (i % 12 == 7) {
          trDom.append(
            $("<td>").html(Math.ceil((i - n - 5) / (2 * n) + 1) + "F"),
          ...
          trDom.append(
            $("<td>").html(Math.ceil((i - n - 5) / (2 * n) + 1) + "I"),
          );
        } else if (i % 12 == 9) {
          trDom.append(
            $("<td>").html(Math.ceil((i - n - 5) / (2 * n) + 1) + "K"),
          );
        } else if (i % 12 == 10) {
          trDom.append(
            $("<td>").html(Math.ceil((i - n - 5) / (2 * n) + 1) + "L"),
          );
        } else if (i % 12 == 11) {
          trDom.append(
            $("<td>").html(Math.ceil((i - n - 5) / (2 * n) + 1) + "M"),
          );
        } else {
          trDom.append(
            $("<td>").html(Math.ceil((i - n - 5) / (2 * n) + 1) + "END"),
          );
        }
      }
      for (j = 0; j < 11; ++j) {
    ...
    if (ajaxReturnData.length == 0) {
      ...
      $("#etching_staff")
        .val(ajaxReturnData[0].etching_staff)
        .removeClass("no-input")
        .addClass("complete-input");
      $("#etching_check_staff")
        .val(ajaxReturnData[0].etching_check_staff)
        .removeClass("no-input")
        .addClass("complete-input");
