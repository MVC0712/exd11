...
$(function () {
  ...
  <tr>
    ...
    <th rowspan="2" style="width: 40px;">Chiều dài</th>
    <th rowspan="2" style="width: 35px;">Lượng kéo</th>
    <th rowspan="2" style="width: 40px;">Độ nhám (Rz)</th>
    <th rowspan="2" style="width: 35px;">Dấu khuôn</th>
    <th rowspan="2" style="width: 30px;">OK /NG</th>
    <th colspan="3" style="width: 75px; text-align: center;">Xác nhận</th>
    <th rowspan="2" style="width: 40px;">Thành phẩm</th>
  </tr>
  <tr>
    
    <th style="width: 25px;">Đùn</th>
    <th style="width: 25px;">Đo</th>
    <th style="width: 25px;">QA</th>
