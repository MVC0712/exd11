...
$(document).on("keydown", "#production_number", function (e) {
  if (e.key === "Enter" || e.keyCode === 13) {
    var fileName = "./php/PressPlan/SelProductionNumberV3.php";
    var sendData = {
...
function makeProductionNumber() {
  var fileName = "./php/PressPlan/SelProductionNumberV2.php";
  var sendData = {
...
function makeSummaryTable() {
  var fileName = "./php/PressPlan/SelSummaryV8.php";
  var sendData = {
...
$(document).on("click", "#save__button", function () {
  var fileName = "./php/PressPlan/InsPressPlanV8.php";
