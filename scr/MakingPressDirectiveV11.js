...
$(function () {
  ...
  <div style="width: 100%; height: 2%; display: flex; border: none; flex-direction: row; justify-content: space-evenly; margin-top : 0px; font-size:large;">
      ...
      <h3 style="width: auto; height: 100%; border: none; padding:0 100px 0 100px; margin: 0; font-size: 20px;">PHIẾU THÔNG TIN SẢN XUẤT</h3>
      <h6 style="width: auto; height: 100%; border: none; padding: 5px 0 0 85px; margin: 0; font-size: 10px;">AEF-09445-A</h6>
  </div>
