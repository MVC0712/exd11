...
$(function () {
  ...
  ${previous_press_note}
          ...
          <div style="width: 100%; height: 100%; margin-top: 5px; margin-right: 5px;">
              <table style="overflow: auto; width : auto;">
                  <thead>
  <tr>
    ...
    <th rowspan="2" style="width: 40px;">Dấu khuôn</th>
    <th rowspan="2" style="width: 45px;">OK /NG</th>
  ...
  <table style="overflow: auto; width: auto; margin-bottom: 10px;">
    ...
    <tbody>
      <tr style="height: 19px;">
        <th style="width: 80px;">Thời gian đùn tổng</th>
  ...
  <table style="overflow: auto; width: auto; margin-bottom: 10px;">
    <thead>
      <tr style="height: 19px;">
        <th style="width: 80px; text-align: left;">Ngày:</th>
        <th style="width: 50px;">Bắt đầu</th>
        <th style="width: 50px;">Kết thúc</th>
      </tr>
    </thead>
    <tbody>
      <tr style="height: 19px;">
        <th style="width: 80px;">Thời gian kéo</th>
        <td style="width: 50px; background-color: #ffff00"></td>
        <td style="width: 50px; background-color: #ffff00"></td>
      </tr>
      ${makeTable2()}
  ...
  <table style="overflow: auto; width: auto;">
    ...
    <tbody>
      <tr style="height: 19px;">
        <th style="width: 80px;">Thời gian cắt</th>
        <td style="width: 50px; background-color: #ffff00"></td>
        <td style="width: 50px; background-color: #ffff00"></td>
      </tr>
      ${makeTable2()}
...
function makeTable2() {
  ...
  for (i = 1; i <= 14; ++i) {
    tr = `<tr style="height: 17.8px">
                <td style="width: 80px; text-align: bottom;">Cây_____ ⇨ Cây_____</td>
                <td style="width: 50px;"></td>
                <td style="width: 50px;"></td>
            </tr>`;
    tbd += tr;
